...
public class DataMocker implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        userService.saveUser(new User(null, "Gabriel Tintarescu", "gabi", "1234", new ArrayList<>()));
        userService.saveUser(new User(null, "Teodor Nicolau", "teo", "1234", new ArrayList<>()));

        userService.addRoleToUser("gabi", "ROLE_USER");
        userService.addRoleToUser("gabi", "ROLE_MANAGER");
